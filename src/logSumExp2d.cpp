...
double LogSumExp2d::getBodyF(const xt::xtensor<double, 1>& P) const {
...
xt::xtensor<double, 1> LogSumExp2d::getBodyFdP(const xt::xtensor<double, 1>& P) const {
...
xt::xtensor<double, 2> LogSumExp2d::getBodyFdPdP(const xt::xtensor<double, 1>& P) const {
...
xt::xtensor<double, 3> LogSumExp2d::getBodyFdPdPdP(const xt::xtensor<double, 1>& P) const {
...
xt::xtensor<double, 2> LogSumExp2d::getWorldMatrixCoefficient(double theta) const {

    xt::xtensor<double, 2> R = getRotationMatrix(theta);
    return xt::linalg::dot(A, xt::transpose(R, {1,0}));
}

xt::xtensor<double, 1> LogSumExp2d::getWorldVectorCoefficient(const xt::xtensor<double, 1>& d, double theta) const {
