...
double LogSumExp2d::getBodyF(const xt::xarray<double>& P) const{
...
xt::xarray<double> LogSumExp2d::getBodyFdP(const xt::xarray<double>& P) const{
...
xt::xarray<double> LogSumExp2d::getBodyFdPdP(const xt::xarray<double>& P) const{
...
xt::xarray<double> LogSumExp2d::getBodyFdPdPdP(const xt::xarray<double>& P) const{
